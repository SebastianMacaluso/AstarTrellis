...
flags.DEFINE_integer('all_pairs_max_size', 8, 'Maximum number of 2 partitions to expand each node')
...
def main(argv):
    ...
    for i in range(1,3):
        ...
        elif FLAGS.trellis_class == 'Approx_IterJetTrellis':
